                    ...
                    @foreach ($products as $product)
                        <article class="card mb-4">
                            <div class="post-slider">
                                <img src="{{ asset($product['img_thumbnail']) }}" class="card-img-top"
                                    alt="post-thumb">
                            </div>
                            <div class="card-body">
                                <h3 class="mb-3"><a class="post-title"
                                        href="{{ url("client/car/{$product['id']}/detail") }}">{{ $product['name'] }}</a>
                                </h3>
                                ...
                                <a href="{{ url("client/car/{$product['id']}/detail") }}"
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-5 text-md-right text-center mb-4">
                                    <ul class="list-inline footer-list mb-0">
                                        ...
                                        <li class="list-inline-item"><a href="#"><i class="ti-youtube"></i></a>
                                        </li>
